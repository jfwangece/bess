...
CommandResponse VPortPrimary::Init(const bess::pb::VPortPrimaryArg &arg) {
  ...
  LOG(INFO) << "Initialized VPort[ZeroCopy, primary]";
  return CommandSuccess();
}

void VPortPrimary::DeInit() {
  char file_name[PORT_NAME_LEN + 256];
...
ADD_DRIVER(VPortPrimary, "vportprimary",
