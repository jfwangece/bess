...
sed -i "s/faas_ip = '128.105.145.255'/faas_ip = '128.105.145.252'/g" $(find . -type f -name "faas_ingress*.bess")
sed -i "s/redis_ip = '128.105.145.196'/redis_ip = '128.105.145.181'/g" $(find . -type f -name "faas_ingress*.bess")
